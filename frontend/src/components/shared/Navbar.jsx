...
//                 <div>
//                     <h1 className='text-2xl font-bold'>Hire<span className='text-[#F83002]'>Stack</span></h1>
//                 </div>
            ...
            <div className='flex items-center justify-between mx-auto max-w-6xl h-16'>
                ...
                <div className='flex items-center gap-8'>
                    ...
                    <Button 
                        ...
                        variant="outline"
                        className="flex items-center gap-2 px-3 py-2 border rounded-lg bg-gray-200 dark:bg-gray-800"
                    >
                        {isDarkMode ? <Sun className="w-5 h-5 text-yellow-300" /> : <Moon className="w-5 h-5 text-gray-600" />}
